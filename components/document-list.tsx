...
import { MoreVertical, FileText, Calendar, User, ArrowUpDown, Plus } from "lucide-react"
...
export function DocumentList({ onSelectDocument }: DocumentListProps) {
  ...
  const handleDocumentAdded = () => {
    console.log("Document added, refreshing list...")
  }
  ...
  return (
    <>
      ...
      <AddDocumentForm open={addDialogOpen} onOpenChange={setAddDialogOpen} onSuccess={handleDocumentAdded} />
    </>
  )
}
